...
public class BankAccount {
     ...
     * @param customerName the name of the account owner
     * @param balance the starting balance of the account
     * @param limit the minimum value of the balance, usually non-positive value
     */
    ...
    /**
     * Decrease method of the account. It will subtract the amount from the balance till the limit allows.
     ...
     * @return
     */
    public double debit(double amount) throws AccountFrozenException {
        if (frozen) {
